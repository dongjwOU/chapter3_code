...
# Input must be a CSV file with headings: "X", "Y", "pct_cover"

####TO DO
# 
# change variable names to collumn numbers
# check which method is most accurate
...
inImage <-'D:\\Chapters\\KNP Data\\Shrub_cover_test\\shrubcov_1.tif'
# Name and path of the output adjusted image 
outImage <-'D:\\Chapters\\KNP Data\\Shrub_cover_test\\shrubcov_1_cor.tif'
...
rf_correct <-function(pointData, inImage, outImage){
...
# Variables removed from the input as will be standardised 
